# Vienkārša loģistikas programma: aprēķina piegādes laiku un izmaksas atkarībā no transporta tipa

# Transporta veidi ar ātrumu (km/h) un cenu (EUR/kg/km)
transporti = {
    "gaisa": {"atrums": 800, "cena": 0.005},
    "jūras": {"atrums": 35, "cena": 0.0001}, 
    "sauszemes": {"atrums": 90, "cena": 0.0002}, 
    "dzelzceļa": {"atrums": 120, "cena": 0.00015}  
}
...
while True:
    ...
    if tips in transporti:
        ...
        izmaksas = svars * cena * attalums  # Izmaksas = svars * cena/kg/km * attālums
        ...
        for transportatips, dati in transporti.items():
            ...
            izmaksas_t = svars * dati["cena"] * attalums
